    ...
    <div class="contain">
        <section class="list">
            ...
            <div class="list-box" ref="list">
                ...
                <!-- <ul :class="['row']" v-for="(minList,listIndex) in list" :key="'out'+listIndex"> -->
                    <transition-group name="item" enter-active-class="animated bounceIn" 
                                    appear
                                    appear-active-class="animated bounceIn">
                        <template v-for="(item,index) in minList">
                            <li  :class="['item']"  :key="'min'+index">
                            <!-- <li :class="['item',{'animated bounceIn':item.animated}]"  :key="'min'+index"> -->
                                <div class="min-box">
                                    <tooltip :content="item.word" :transfer="true" :key="'min'+index">
                                    <div class="emoji">{{item.face}}</div>
                                    <p class="title">{{item.word}}</p>
                                    </tooltip>
                                </div>
